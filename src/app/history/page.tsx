...
import { Library, Clock, AlertCircle, Play, Calendar, Trash2, ArrowRight } from "lucide-react";
          ...
          >
            <div className="flex items-center justify-between gap-6 mb-12">
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mt-1">{t("historyDesc")}</p>
                </div>
              </div>
            </div>
            ...
            {loading || status === "loading" ? (
              ...
              >
                ...
                <h2 className="text-xl font-bold mb-3 text-red-900">{t("unexpectedError")}</h2>
              ...
              >
                ...
                <h2 className="text-2xl font-bold mb-4">{t("historyEmpty")}</h2>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                              <div className="flex items-center gap-1.5 bg-muted px-3 py-1.5 rounded-full border border-border font-bold text-[11px] text-muted-foreground uppercase tracking-wide">
                                <Calendar size={12} />
                                {formatDate(String(item.watchedAt))}
                              </div>
            ...
            {history.length > 0 && (
              ...
              >
                <div className="inline-flex items-center gap-4 px-8 py-3 bg-muted rounded-full text-[11px] font-bold text-muted-foreground uppercase tracking-widest border border-border">
                  <span>{t("totalHistory").replace("{count}", String(history.length))}</span>
                </div>
              </motion.div>
            )}
          </motion.div>
