...
import { PlaySquare, Trash2, AlertCircle, Users, ArrowRight, Video } from "lucide-react";
...
export default function SubscriptionsPage() {
  ...
  const fetchSubscriptions = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || t("fetchSubscriptionsFailed"));
      }
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="flex items-center gap-5 mb-12">
              ...
              <div>
                <h1 className="text-3xl font-black tracking-tight">{t("subscriptions")}</h1>
                <p className="text-muted-foreground text-sm font-medium mt-1">{t("subscriptionsDesc")}</p>
              </div>
            </div>
            ...
            {loading || status === "loading" ? (
              ...
              >
                ...
                <h2 className="text-xl font-black mb-3 text-red-900">{t("unexpectedError")}</h2>
              ...
              >
                ...
                <h2 className="text-3xl font-black mb-4">{t("subscriptionsEmpty")}</h2>
            ...
            {subscriptions.length > 0 && (
              ...
              >
                <div className="inline-flex items-center gap-4 px-8 py-3 bg-muted rounded-full text-[11px] font-black text-muted-foreground uppercase tracking-widest border border-border">
                  <span>{t("totalSubscriptions").replace("{count}", String(subscriptions.length))}</span>
                </div>
              </motion.div>
            )}
          </motion.div>
