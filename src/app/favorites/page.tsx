          ...
          >
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mt-1">{t("favoritesDesc")}</p>
                </div>
              </div>
            ...
            {!isLoaded ? (
              ...
              >
                ...
                <h2 className="text-2xl font-bold mb-4">{t("favoritesEmpty")}</h2>
            ...
            {allFavorites.length > 0 && filteredFavorites.length > 0 && (
              ...
              >
                <div className="inline-flex items-center gap-4 px-6 py-2.5 bg-muted rounded-full text-[10px] font-bold text-muted-foreground uppercase tracking-widest border border-border">
                  <span>{t("totalFavorites").replace("{count}", String(allFavorites.length))}</span>
                </div>
              </motion.div>
            )}
          </motion.div>
