            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mt-1">{t("watchLaterDesc")}</p>
                </div>
              </div>
            ...
            {!isLoaded ? (
              <div className="flex flex-col items-center justify-center py-40 space-y-4">
                <div className="relative">
                  ...
                  <div className="absolute top-0 start-0 w-12 h-12 border-4 border-blue-600 border-t-transparent rounded-full animate-spin"></div>
                </div>
                <p className="text-muted-foreground text-sm font-medium animate-pulse tracking-wide">{t("loading")}</p>
              </div>
              ...
              >
                ...
                <h2 className="text-2xl font-bold mb-4">{t("watchLaterEmpty")}</h2>
                <p className="text-muted-foreground mb-10 leading-relaxed text-lg">
                  {t("watchLaterEmptyDesc")}
                </p>
                <Link
                  href="/"
            ...
            {allWatchLater.length > 0 && filteredWatchLater.length > 0 && (
              ...
              >
                <div className="inline-flex items-center gap-4 px-6 py-2.5 bg-muted rounded-full text-[10px] font-bold text-muted-foreground uppercase tracking-widest border border-border">
                  <span>{t("totalWatchLater").replace("{count}", String(allWatchLater.length))}</span>
                </div>
              </motion.div>
            )}
          </motion.div>
