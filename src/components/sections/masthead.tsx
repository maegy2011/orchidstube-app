  ...
  return (
    <header className={`fixed ${headerTop} inset-x-0 z-[8000] flex flex-col`}>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          type="button"
          className="relative z-20 p-2.5 rounded-full hover:bg-muted/80 transition-all active:scale-95 hover:shadow-md touch-manipulation"
        ...
        <Link href="/" onClick={handleClearState} className="flex items-center group ml-2 sm:ml-3 shrink-0">
          <div className="flex items-center">
            <div className="relative flex items-center justify-center w-8 h-8 sm:w-16 sm:h-16 overflow-hidden">
              <div className={cn(
