...
const DEFAULT_CONFIG: ContentFilterConfig = {
  enabled: true,
  defaultDeny: true,
  allowedCategories: ['education', 'quran', 'programming', 'science', 'documentary', 'kids', 'nature', 'health', 'cooking', 'crafts'],
  whitelist: [],
  blockedKeywords: [
    // Violence and weapons
    'قتال', 'violence', 'سلاح', 'weapon', 'حرب', 'war', 'إرهاب', 'terrorism',
    // Adult content
    'porn', 'sex', 'إباحي', 'عاري', 'nude', 'erotic',
    // Drugs and alcohol
    'مخدرات', 'drugs', 'alcohol', 'خمر', 'سكر',
    // Gambling
    'قمار', 'gambling', 'casino', 'رهان', ' bet',
    // Hate speech
    'كراهية', 'hate speech', 'عنصرية', 'racism',
    // Scams
    'احتيال', 'scam', 'نصب', 'fraud',
  ],
  maxResults: 50,
};
